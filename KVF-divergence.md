...
| `Sources/ReticulumSwift/Protocol/MessagePack.swift` | +26/−12 | Decoder depth cap |
| `Sources/ReticulumSwift/Transport/TCPTransport.swift` | +34/−3 | Lock-guarded state, queue-serialized API (crash fix) |
| `Sources/ReticulumSwift/Crypto/RatchetManager.swift` | +12/−2 | Ratchet file protection + backup exclusion |
